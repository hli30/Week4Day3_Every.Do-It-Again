...
-(void)passInfo:(NSString *)title andDescription:(NSString *)todoDescription andPriorityNumber:(NSString *)priorityNumber{
    ...
    newManagedObject.todoDescription = todoDescription;
    newManagedObject.priorityNumber = priorityNumber;
...
- (void)configureCell:(MyTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.priorityNumberLabel.text = [[object valueForKey:@"priorityNumber"] description];
}
